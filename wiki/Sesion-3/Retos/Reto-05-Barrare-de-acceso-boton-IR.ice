    ...
    "graph": {
      "blocks": [
        ...
        },
        {
          ...
          "type": "basic.info",
          "data": {
            "info": "## Reto 5: Barrera de acceso controlada por botón e IR\n\nCon el botón SW1 se levanta la barrera  \nCon el IR se cierra la barrera. Es el sensor que detecta que el coche  \nha entrado dentro del recinto",
            "readonly": true
          },
          "position": {
            "x": 88,
