  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        ...
        {
          "id": "90ba245e-e1aa-4447-87ef-1c9b2a08240b",
          "type": "basic.output",
          "data": {
            "name": "LEDS",
            "range": "[3:0]",
        ...
        },
        {
          ...
          "type": "basic.info",
          "data": {
            "info": "## Reto 16: Escáner de supermercado\n\nEscanea y cuenta los productos",
            "readonly": true
          },
          "position": {
            "x": -760,
        ...
        {
          "id": "a1b481fd-b445-4613-8816-4ad4844f79bc",
        ...
        {
          "id": "0040eecb-1c16-4c97-905e-8225c22fe57e",
          "type": "basic.info",
          "data": {
            "info": "Contador de artículos  \nescaneados",
            "readonly": true
          },
          "position": {
            "x": -352,
      ...
      "wires": [
        ...
        },
        {
          ...
          "target": {
            "block": "a1b481fd-b445-4613-8816-4ad4844f79bc",
        ...
        },
        {
          ...
          "target": {
            "block": "90ba245e-e1aa-4447-87ef-1c9b2a08240b",
            "port": "in"
          },
          "size": 4
        },
