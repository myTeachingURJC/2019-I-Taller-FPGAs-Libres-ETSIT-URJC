{
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        {
          "id": "7291d260-8574-4799-bd2b-16aa78dcd982",
          "type": "basic.output",
          "data": {
            "name": "LEDS",
            "range": "[7:0]",
        ...
        {
          "id": "00a8afba-bc01-42b3-bcc0-987062480a6f",
          "type": "basic.input",
          "data": {
            "name": "Serial",
            "pins": [
        ...
        },
        {
          ...
          "type": "basic.info",
          "data": {
            "info": "## Reto 14: Recepción serie con pitido\n\nPor cada carácter recibido se emite un pitido corto de  \nfeedback",
            "readonly": true
          },
          "position": {
            "x": -680,
        ...
        {
          "id": "a80fcc81-3a32-4df4-90c7-9cba0784779f",
      ...
      "wires": [
        ...
        {
          "source": {
            "block": "00a8afba-bc01-42b3-bcc0-987062480a6f",
            "port": "out"
          },
          "target": {
            "block": "a80fcc81-3a32-4df4-90c7-9cba0784779f",
        ...
        },
        {
          ...
          "target": {
            "block": "7291d260-8574-4799-bd2b-16aa78dcd982",
            "port": "in"
          },
          "size": 8
        }
