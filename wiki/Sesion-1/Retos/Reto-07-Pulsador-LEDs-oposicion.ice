    ...
    "graph": {
      "blocks": [
        ...
        },
        {
          ...
          "type": "basic.info",
          "data": {
            "info": "## Reto 7: LEDs en oposición de fase\n\nLos dos LEDs siempre están en estado opuestos: cuando  \nuno está encendido, el otro está apagado, y vice-versa  \n\nCon el pulsador se cambia su estado",
            "readonly": true
          },
          "position": {
            "x": 168,
