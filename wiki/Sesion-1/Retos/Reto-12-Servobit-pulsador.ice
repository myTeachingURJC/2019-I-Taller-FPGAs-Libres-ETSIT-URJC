{
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        {
          "id": "3ef621bd-3d3f-4791-bed1-b71b852b53c8",
          "type": "basic.output",
          "data": {
            "name": "Servo",
            "pins": [
        ...
        {
          "id": "9b55bd37-7e8c-42d0-8a14-38a8d2d4b3ea",
          "type": "basic.input",
          "data": {
            "name": "Boton",
            "pins": [
        ...
        {
          "id": "b9be0604-50c6-4889-9950-ad6079e4ae3f",
          "type": "basic.output",
          "data": {
            "name": "LED",
            "pins": [
        ...
        {
          "id": "482ee5f0-f403-4e88-81fc-ca4bb86d4ea4",
          "type": "basic.output",
          "data": {
            "name": "LED",
            "pins": [
        ...
        },
        {
          ...
          "type": "basic.info",
          "data": {
            "info": "## Reto 12: Servobit controlado con un pulsador\n",
            "readonly": true
          },
          "position": {
            "x": -184,
        ...
        {
          "id": "90ddc7c2-f112-4694-8180-26330dfdc888",
        ...
        {
          "id": "46535c6d-43db-41ba-ac98-8a337d33ce44",
        ...
        {
          "id": "135f3b15-2edb-4486-baf6-d0bd63508adc",
          "type": "basic.info",
          "data": {
            "info": "Circuito anterior. En Hardware todo va  \nen paralelo. Mientras movemos el  \nservo podemos jugar con el spiner",
            "readonly": true
          },
          "position": {
            "x": -144,
        ...
        {
          "id": "e5df457f-f36c-407a-bf0b-ded14d09f889",
          "type": "basic.info",
          "data": {
      ...
      "wires": [
        ...
        },
        {
          ...
          "target": {
            "block": "b9be0604-50c6-4889-9950-ad6079e4ae3f",
            "port": "in"
          }
        },
        {
          ...
          "target": {
            "block": "90ddc7c2-f112-4694-8180-26330dfdc888",
        ...
        },
        {
          ...
          "target": {
            "block": "482ee5f0-f403-4e88-81fc-ca4bb86d4ea4",
            "port": "in"
          }
        },
        {
          "source": {
            "block": "9b55bd37-7e8c-42d0-8a14-38a8d2d4b3ea",
            "port": "out"
          },
          "target": {
            "block": "46535c6d-43db-41ba-ac98-8a337d33ce44",
        ...
        },
        {
          ...
          "target": {
            "block": "3ef621bd-3d3f-4791-bed1-b71b852b53c8",
            "port": "in"
          }
        }
      ]
